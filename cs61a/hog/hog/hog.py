...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    rolls=1
    while rolls<=10:
        score=make_averaged(roll_dice, total_samples)(rolls,dice)
        if score>max_score:
            max_rolls=rolls
            max_score=score
        rolls+=1
...
def fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    if fuzzy_update(0, score, opponent_score, dice=six_sided)-score>=threshold:
        return 0
    else:
        return num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if fuzzy_update(0, score, opponent_score, dice=six_sided)>=GOAL:
        return 0
    else:
        return fuzzy_strategy(score, opponent_score, threshold=12, num_rolls=6)
